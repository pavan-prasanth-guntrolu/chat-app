            ...
            <div className='bg-gray-800 border border-gray-700 rounded-lg p-8'>
                <div className="text-center mb-8">
                    ...
                    <p className='text-gray-300 text-lg'>
                        Enter you email to continue you journey
                    </p>
                </div>
                <form onSubmit={handleSubmit} className='space-y-6'>
                    <div>
                        ...
                        <input type='email' id="email" className='w-full px-4 py-4 bg-gray-700 border border-gray-600 rounder-lg text-white placeholder-gray-400 mb-8' placeholder='Enter your email address' required value={email} onChange={(e)=>setEmail(e.target.value)}/>
