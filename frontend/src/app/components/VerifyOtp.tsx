        ...
        <div className="bg-gray-800 border border-gray-700 rounded-lg p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              {error && (
                <div className="bg-red-600 border border-red-700 rounded-lg p-3 mt-8">
                  <p className="text-red-300 text-sm text-center">{error}</p>
                </div>
              )}
              <button
                type="submit"
                className="w-full bg-blue-600 text-white py-4 px-6 rounded-lg font-semibold hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed mt-8"
                disabled={loading}
              >
                {loading ? (
          ...
          <div className="mt-6 text-center">
            ...
            {timer > 0 ? (
              ...
              >
                {resendingLoading ? "sending..." : "Resend Code"}
              </button>
            )}
          </div>
        </div>
